...
async function getConfirmedCasesDailyData() {
    ...
    if (confirmedCasesData.length == 0) {
        ...
        confirmedCasesData = data.MUS.data;
...
$('#vacinTitle').click(function () {
    ...
    document.getElementById('Vaccine').innerHTML = commaSeparateNumber(yVaccinatedPeopleDailyData[yVaccinatedPeopleDailyData.length - 1]) + "%";
...
async function getAirlineRestritions() {
    ...
    data.forEach(obj => {
        ...
        if (obj.adm0_name == "Mauritius") {
            result += "<br><strong>Published:</strong> " + obj.published + "<br><strong>Source:</strong> " + obj.source + "<br><strong>Airline:</strong> " + obj.airline + "<br>" + obj.info;
        }
